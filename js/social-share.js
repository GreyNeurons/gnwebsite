...
tpl.innerHTML = `
  ...
  <a id="twitter-share" target="_blank" title="Share on Twitter">
    <svg viewBox="0 0 24 24"><path d="M22.46 6c-.77.35-1.6.58-2.46.69a4.3 4.3 0 0 0 1.88-2.37 8.6 8.6 0 0 1-2.72 1.04 4.28 4.28 0 0 0-7.3 3.9A12.13 12.13 0 0 1 3.15 4.7a4.28 4.28 0 0 0 1.32 5.72 4.24 4.24 0 0 1-1.94-.54v.06a4.28 4.28 0 0 0 3.43 4.2 4.3 4.3 0 0 1-1.93.07 4.28 4.28 0 0 0 4 2.97A8.6 8.6 0 0 1 2 19.54a12.11 12.11 0 0 0 6.56 1.92c7.88 0 12.2-6.53 12.2-12.2 0-.19-.01-.39-.02-.58A8.7 8.7 0 0 0 24 5.5a8.6 8.6 0 0 1-2.54.7z"/></svg>
  </a>
  <a id="linkedin-share" target="_blank" title="Share on LinkedIn">
    <svg viewBox="0 0 24 24"><path d="M4.98 3.5a2.5 2.5 0 1 0 .02 5 2.5 2.5 0 0 0-.02-5zm.02 7h4.96v12h-4.96v-12zm7 0h4.76v1.65h.07c.66-1.25 2.27-2.56 4.67-2.56 5 0 5.93 3.28 5.93 7.54v8.37h-4.96v-7.4c0-1.76-.03-4.03-2.46-4.03-2.46 0-2.84 1.92-2.84 3.91v7.52h-4.96v-12z"/></svg>
  </a>
  <a id="bluesky-share" target="_blank" title="Share on Bluesky">
    <svg viewBox="0 0 24 24">
      <circle cx="12" cy="12" r="10" fill="#1FBAD6"/>
      <text x="12" y="16" text-anchor="middle" font-size="12" fill="#fff" font-family="Arial, sans-serif">b</text>
    </svg>
  </a>
  <a id="whatsapp-share" target="_blank" title="Share on WhatsApp">
    <svg viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.148-1.758-.867-2.03-.967-.273-.099-.472-.148-.672.149-.198.297-.768.967-.94 1.165-.173.198-.347.223-.644.074-.297-.148-1.255-.462-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.297-.347.446-.52.149-.174.198-.298.297-.496.099-.198.05-.371-.025-.52-.074-.148-.672-1.612-.92-2.207-.242-.581-.487-.5-.672-.51l-.57-.01c-.198 0-.52.074-.792.372s-1.04 1.016-1.04 2.479 1.065 2.876 1.213 3.074c.148.198 2.095 3.2 5.076 4.487.709.306 1.26.489 1.689.626.71.226 1.36.194 1.872.118.571-.085 1.758-.719 2.007-1.413.248-.695.248-1.29.173-1.413-.074-.123-.272-.198-.57-.347z"/></svg>
  </a>
  <a id="email-share" target="_blank" title="Share via Email">
